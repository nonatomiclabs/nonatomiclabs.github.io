...
Date: 2015-06-05
Category: Binaural, MPEG
Summary: While "linear" or traditionnal TV is getting stuck because of the expanding variety of media (such as TV, computers, tablets or phones) and new means of consumption, MPEG-H has been defined to be flexible; this is especially true when talking about the audio part of MPEG-H.
...
![Traditional audio framework]({attach}traditional-framework.png)
...
[Download this article.](http://nonatomiclabs.com/blog/wp-content/uploads/2015/06/MPEG_H_Audio_Fitting_Every_Device.pdf)